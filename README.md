...
This component allows storage of Media Asstes inside or outside Sharepoint (Sharepoint List, File System FTP server or AmazonS3).
...
1. Install prerequisites:
	On the application server(s) which will run the timer job:
		- .Net Framework 4.0	
		- Expression Encoder 4 Pro - fully activated (To verify it is fully activated open the program and see the Help-About dialog. It must NOT say ô(without codecs)ö after the ôMicrosoft Expression Encoder 4 Proö name)
